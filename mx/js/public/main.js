...
$(function() {
//xz
$('.excerpts .thumb').lazyload({data_attribute: 'src',threshold: 400});
$('.postitems .thumb').lazyload({data_attribute: 'src',threshold: 400});
$('.sidebar .thumb').lazyload({data_attribute: 'src',threshold: 400});
$('.sidebar .avatar').lazyload({data_attribute: 'src',threshold: 400});
$('.article-content .thumb').lazyload({data_attribute: 'src',threshold: 400});
});
//手机菜单
//xz
...
$(".hide_box").fadeToggle();
$(".mobile_box").fadeToggle();
}
//手机弹窗
$(function() {
  $('.appdown').click(function() {
    $('.appdown').hide();
    $.cookie("closeAPP", "hide", {path: '/',expires: expiresDate});
  });
  ...
  if (closeAPP) {
    ...
    $('.appdown').show();
    $('.appdown img').show().height(256).width(300);
    $('.appdown .close').show().height(23).width(62);
  };
})
...
function myFunction(){
var s= document.getElementById('imgurl').innerHTML;
s=s.replace(/imageurl/g,"https://img.mixiuimg.top/");
document.getElementById('imgurl').innerHTML=s;
}}
else {
};